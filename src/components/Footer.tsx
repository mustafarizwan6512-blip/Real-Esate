      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          <div className="col-span-1">
            ...
            <p className="text-secondary-dark/80 text-sm leading-relaxed mb-6 max-w-sm">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.youtube.com/@referestates" target="_blank" rel="noopener noreferrer" className="text-secondary hover:text-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link to="/" className="text-secondary-dark/80 hover:text-primary text-sm transition-colors">Home</Link></li>
              <li><Link to="/projects" className="text-secondary-dark/80 hover:text-primary text-sm transition-colors">Selected Projects</Link></li>
              <li><a href="/#about" className="text-secondary-dark/80 hover:text-primary text-sm transition-colors">About Us</a></li>
              <li><Link to="/contact" className="text-secondary-dark/80 hover:text-primary text-sm transition-colors">Contact Advisory</Link></li>
              <li><a href="/sitemap.xml" target="_blank" rel="noopener noreferrer" className="text-secondary-dark/80 hover:text-primary text-sm transition-colors">XML Sitemap</a></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-secondary/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6 text-xs text-secondary-dark/60">
            <Link to="/contact" className="hover:text-primary transition-colors">VIP Advisory</Link>
          </div>
        </div>
      </div>
    </footer>
