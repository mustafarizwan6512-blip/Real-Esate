    ...
    <div id="contact" className={`w-full py-24 scroll-mt-20 ${isStandalonePage ? 'pt-32 min-h-screen bg-cream' : ''}`}>
      {isStandalonePage && (
        <SEO 
          ...
          canonical="https://www.referestates.com/contact"
            ...
            <div>
              ...
              <div className="space-y-3 pt-2 mb-8">
                ...
                >
                  ...
                  <span>+966 53 660 9534 (WhatsApp)</span>
                </a>
                <a
          ...
          <div className="lg:col-span-7 bg-surface border border-secondary/10 p-8 md:p-12 relative shadow-sm">
            {!isSubmitted ? (
              <form onSubmit={handleSubmit} className="flex flex-col gap-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    <label className="block font-display font-bold text-[10px] tracking-widest uppercase text-secondary/70 mb-2">Preferred Location</label>
                    <input 
                      name="city" 
                      value={formData.city} 
                      onChange={handleChange} 
                      type="text" 
                      placeholder="Any Location in Makkah Region" 
                      className="w-full bg-transparent border-b border-secondary/20 py-2 focus:outline-none focus:border-primary text-secondary placeholder-secondary/30 text-sm font-body" 
                    />
                  </div>
                  <div>
