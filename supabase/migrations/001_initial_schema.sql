...
('55555555-5555-5555-5555-555555555555', 'Eqnaa Real Estate', 'eqnaa-real-estate', 'Leading real estate developer in Jeddah.', true, true)
...
('dddddddd-4444-4444-4444-444444444444', '55555555-5555-5555-5555-555555555555', 'ASAIL 59 & 60', 'asail-59-60', 'Apartment & Penthouse', 'Jeddah', 'Darb Al Haramain', 'Darb Al Haramain, Jeddah', 'We are pleased to introduce ASAIL 59 & 60 residential project in Jeddah. Designed with diverse layouts, it offers an unparalleled experience in residential luxury, spanning over 2,000 square meters. A state-of-the-art fitness club, A dedicated children''s play area, A hotel-style lobby, Recreational spaces, Advanced surveillance systems, and many more amenities, in addition to its prime location, the project allows you to reach major landmarks within minutes.', 'Luxury apartment & penthouse development in Darb Al Haramain, Jeddah by Eqnaa Real Estate.', '2, 3, 4, 5 Beds', '2 - 5 Baths', 315000, 'SAR', 'Under Construction', true, '/asail-exterior.jpg')
ON CONFLICT (slug) DO NOTHING;
