-- ==============================================================================
-- REFERESTATES Supabase Migration - 006: Fix Admin RLS Recursion & Storage Policies
-- ==============================================================================
...
-- 2. Drop existing policies on public schema tables
...
-- Drop existing storage.objects policies
...
-- 3. Non-Recursive Security Definer Functions
...
-- 7. public.property_media Policies
...
-- 9. public.website_content Policies
...
-- 11. public.activity_logs Policies
